...
def make_gradcam_heatmap(image_path, model=None, pred_index=None):
    # Set last conv layer name for InceptionV3
    last_conv_layer_name = 'mixed10'
    model = tf.keras.applications.InceptionV3(weights='imagenet')

    # Load and preprocess image
    image = tf.keras.utils.load_img(image_path, target_size=(299, 299))  # Inception expects 299x299
...
def save_and_overlay_gradcam(img_path, heatmap, cam_path="static/gradcam/cam_inception.jpg", alpha=0.4, img_size=299):
